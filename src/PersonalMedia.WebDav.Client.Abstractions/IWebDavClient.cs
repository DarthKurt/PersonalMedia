...
public interface IWebDavClient
{
    ...
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="PropFindResponse" />.</returns>
    Task<PropFindResponse> PropFind(string requestUri, CancellationToken cancellation);
    ...
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="PropFindResponse" />.</returns>
    Task<PropFindResponse> PropFind(Uri? requestUri, CancellationToken cancellation);
    ...
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="PropFindResponse" />.</returns>
    Task<PropFindResponse> PropFind(string requestUri, PropFindParameters parameters, CancellationToken cancellation);
    ...
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="PropFindResponse" />.</returns>
    Task<PropFindResponse> PropFind(Uri? requestUri, PropFindParameters parameters, CancellationToken cancellation);
    ...
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="PropFindResponse" />.</returns>
    Task<PropFindResponse> Search(string requestUri, SearchParameters parameters, CancellationToken cancellation);
    ...
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="PropFindResponse" />.</returns>
    Task<PropFindResponse> Search(Uri? requestUri, SearchParameters parameters, CancellationToken cancellation);

    /// <summary>
    /// Get capabilities with an OPTIONS operation.
    /// </summary>
    /// <param name="cancellation">A <see cref="CancellationToken"/> for the request.</param>
    /// <returns>An instance of <see cref="WebDavResponse" />.</returns>
    Task<WebDavCapabilitiesResponse> GetCapabilities(CancellationToken cancellation);
}